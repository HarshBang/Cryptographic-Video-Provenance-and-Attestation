                    ...
                    <div className="flex flex-col gap-6 w-full">
                        ...
                        {status === "result" && (
                            <div
                                ...
                                className="w-full h-[400px] border-2 border-dashed border-vca-border-dark rounded-2xl bg-vca-surface-dark flex flex-col items-center justify-center cursor-pointer hover:border-primary/50 hover:bg-white/5 transition-all group group-hover:bg-vca-surface-dark opacity-80"
                            >
                                <div className="w-16 h-16 rounded-full bg-slate-800 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
